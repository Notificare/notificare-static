...
var hyperlink_rules = {
    ...
    'a.togglemenu:click' : function(e) {
        /**
        * Event: click
        * Action: Toggle menu on mobile device
        */
    	e.stop();
        $(this).toggleClassName('showmenu');

        if($(this).hasClassName('showmenu')) {
        	$(this).update('Hide Menu');
        	this.next().addClassName('show');
        } else {
        	$(this).update('Show Menu');
        	this.next().removeClassName('show');
        }
...
var charts_rules = {
		'.chart-lastmonth': function(){
			new Notificare.Charts(this,{
				...
				apiBaseUrl: $('api-info').getDataAttribute('baseUrl')
			});
		},
...
var intro_rules = {
		'div.intro-rotator': function() {
			new TabRotator(this, {
				contentElementSelector: '.intro-images-rotator',
				tabsElementSelector: '.intro-loader-rotator',
				parameterName: 'itemID',
				interval: 2,
				animateLoader: false,
				animatingLoaderClass: 'campaign-loader-animating',
...
//
//var home_block1_rules = {
//		'.rich-content': function() {
//			new TabRotator(this, {
//				contentElementSelector: 'feature-lists ul',
//				tabsElementSelector: '.iphone ul',
//				parameterName: 'itemID',
//				interval: 3,
//				animateLoader: false,
//				animatingLoaderClass: 'campaign-loader-animating',
...
//		}
//	};
//Event.addBehavior(home_block1_rules);
...
var home_rules = {
		'.newhome': function(){
			new Home(this,{
				token: $('user-token').getDataAttribute('token'),
				blocks: ['.rich-content','.communication-content','.home-dashboard-features','.blog-review','.press-box','.mainfooter']
			});
		}
	};
Event.addBehavior(home_rules);
